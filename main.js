...
function setDarkMode() {
  ...
  Array.from(document.querySelectorAll(".burgerslice")).forEach((e) =>
    e.classList.remove("burgerslice-light")
  );
  document
    .querySelector(".dropdown-content")
    .classList.remove("drop-cont-light");
  ...
  Array.from(document.querySelectorAll(".inpbox")).forEach((e) =>
    e.classList.add("inpbox-dark")
  );
...
function setLightMode() {
  ...
  Array.from(document.querySelectorAll(".inpbox")).forEach((e) =>
    e.classList.remove("inpbox-dark")
  );
  document
    .querySelector(".dropdown-content")
    .classList.remove("drop-cont-dark");

  document.querySelector(".navbar").classList.add("navbar-light");
  Array.from(document.querySelectorAll(".line")).forEach((e) =>
    e.classList.add("line-light")
  );
  ...
  Array.from(document.querySelectorAll(".burgerslice")).forEach((e) =>
    e.classList.add("burgerslice-light")
  );
  document.querySelector(".dropdown-content").classList.add("drop-cont-light");
}
function setDefaultTheme() {
  let sysdef = document.querySelector(".dropdown-content a").nextElementSibling
    .nextElementSibling;
  ...
  Array.from(noteObj).forEach((element, index) => {
    html += ` <div class="col-lg-4 col-md-6 col-sm-12 signature">
        <div class="card">
            ...
            <div class="setendwm"><button class="btn btn-dark" id="${Math.floor(
              100000 + Math.random() * 900000
            )}" onclick="updateNote(this.id)">Edit</button><button id=${index} onclick=delNote(this.id) class="btn btn-dark">Remove</button></div>
        </div>
    </div>`;
  });
  if (noteObj.length != 0) {
...
function updateNote(id) {
  ...
  ttl.value =
    editBtn.parentElement.previousElementSibling.previousElementSibling.innerHTML;
}
